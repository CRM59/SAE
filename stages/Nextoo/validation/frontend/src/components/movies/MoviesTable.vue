<template>
  <table>
    ...
    <tr v-for="movie in movies" :key="movie.id">
      ...
      <td class="watched-button-td"><button class="watched-button" @click.prevent="$emit('MoviesTable_markMovieAsWatched', {pid: pid, mid: movie.id})"><img src="../../assets/img/vue.png" alt=""></button></td>
    </tr>
    </tbody>
  </table>
</template>
...
<script setup>
  ...
  defineEmits(["MoviesTable_markMovieAsWatched"])
